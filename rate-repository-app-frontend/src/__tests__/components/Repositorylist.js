    ...
    describe('RepositoryListContainer', () => {
      it('renders repository information correctly', () => {
        ...
        repositories.edges.forEach((edge,i) => {
            ...
            expect(description[i]).toHaveTextContent(edge.node.description);
            expect(language[i]).toHaveTextContent(edge.node.language);
            expect(review[i]).toHaveTextContent(edge.node.reviewCount);
        })
      });
    });
  });